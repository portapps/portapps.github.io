> {% gemoji bulb %} Firefox [Standard]({{ site.baseurl }}/app/firefox-portable/) and [ESR (Extended Support Release)]({{ site.baseurl }}/app/firefox-esr-portable/) are also available
